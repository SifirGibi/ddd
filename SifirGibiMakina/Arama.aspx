<%@ Page Title="" Language="C#" MasterPageFile="~/Makina.Master" AutoEventWireup="true" CodeBehind="Arama.aspx.cs" Inherits="SifirGibiMakina.Arama" EnableEventValidation="true"%>
                  ...
                  <div class="card-header">İlan Arama</div>
                    <div class="card-body">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                         <asp:DropDownList ID="ddTurlerAlt2" runat="server" CssClass="form-control select2" Width="100%">
                        </asp:DropDownList>
                        </div>
                        <div class="form-group">
                          <asp:DropDownList ID="ddMarkalar" runat="server" CssClass="form-control select2" Width="100%">
                        </asp:DropDownList>
                        </div>
                    </div>
                  </div>
     ...
     <div class="form-group">
                        ...
                        <div class="form-group">
                         <asp:DropDownList ID="ddTurlerAltMobil" runat="server" CssClass="form-control select2" Width="100%" OnSelectedIndexChanged="ddTurlerAlt_SelectedIndexChanged" AutoPostBack="true">
                          ...
                          <div class="form-group">
                         <asp:DropDownList ID="ddTurlerAlt2Mobil" runat="server" CssClass="form-control select2" Width="100%">
                        </asp:DropDownList>
                        </div>
                        <div class="form-group">
                          <asp:DropDownList ID="ddMarkalarMobil" runat="server" CssClass="form-control select2" Width="100%">
                        </asp:DropDownList>
                        </div>
                      </div>
                    </div>
              ...
              <div class="makine-liste-list-item">
                <div class="card mb-3" style="max-width: 540px;">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-7">
                      <div class="card-body">
                        <p class="card-category"><a href="/ilan-<%# Eval("SEOUrl") %>" style="color:#44b276;font-size:11px"><%# Eval("TurAdı") %></a></p>
