...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="breadcrumb-comp">
        <div class="container">
          <div class="row">
           ...
           <asp:LinkButton ID="lnkResetSession" runat="server" Text="Makine Al" OnClick="lnkResetSession_Click"></asp:LinkButton>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="sidebar">
                <div class="card sm-d-none">
                  <div class="card-header">İlan Arama</div>
                    <div class="card-body">
                        <input type="hidden" id="hdnSecilenTurID" runat="server" value="0" />
    ...
    <p>Durum</p>
    <div class="form-group">  
      <asp:RadioButtonList ID="rblStatus" runat="server" CssClass="form-control select2" RepeatDirection="Vertical"  AutoPostBack="true" OnSelectedIndexChanged="rblStatus_SelectedIndexChanged">
 </asp:RadioButtonList>
    </div>
</div>
                    </div>
  ...
  <p>İlan Tarihi</p>
  <div class="form-group">
    <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="form-control select2 selecet-extra" Width="100%" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
    <asp:ListItem Text="Son 24 Saat" Value="1" CssClass="radio-item form-control"></asp:ListItem>
  <asp:ListItem Text="Son 7 Gün" Value="2" CssClass="radio-item form-control"></asp:ListItem>
  <asp:ListItem Text="Son 15 Gün" Value="3" CssClass="radio-item"></asp:ListItem>
  <asp:ListItem Text="Son 30 Gün" Value="4" CssClass="radio-item"></asp:ListItem>
    </asp:RadioButtonList>
  </div>
</div>
...
.Sayfalama span{
    ...
    padding: 0 5px;
        ...
        .selecet-extra{
            ...
            display:table;
                            ...
                            <cc1:CollectionPager ID="CollectionPager1" PageSize="24" runat="server" BackNextLocation="Split" BackText=" < "   FirstText=" İlk " LabelText=" " LastText=" Son " NextText=" > " QueryStringKey="Sayfa" ResultsFormat="Sayfa {0}-{1} (Toplam {2} ilan)" ControlCssClass="Sayfalama" MaxPages="1000"  HideOnSinglePage="True" PagingMode="PostBack" ></cc1:CollectionPager>
    ...
    <p>Durum</p>
    <div class="form-group">  
      <asp:RadioButtonList ID="rblStatus2" runat="server" CssClass="form-control select2" RepeatDirection="Vertical"  AutoPostBack="true" OnSelectedIndexChanged="rblStatus_SelectedIndexChanged">
 </asp:RadioButtonList>
    </div>
</div>
                      </div>
  ...
  <p>İlan Tarihi</p>
  <div class="form-group">
    <asp:RadioButtonList ID="RadioButtonList2" runat="server" CssClass="form-control select2 selecet-extra" Width="100%" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
    <asp:ListItem Text="Son 24 Saat" Value="1" CssClass="radio-item form-control"></asp:ListItem>
  <asp:ListItem Text="Son 7 Gün" Value="2" CssClass="radio-item form-control"></asp:ListItem>
  <asp:ListItem Text="Son 15 Gün" Value="3" CssClass="radio-item"></asp:ListItem>
  <asp:ListItem Text="Son 30 Gün" Value="4" CssClass="radio-item"></asp:ListItem>
...
.Sayfalama span{
    ...
    padding: 0 5px;
                       ...
                       <cc1:CollectionPager ID="CollectionPager2" PageSize="24" runat="server" BackNextLocation="Split" BackText=" < "   FirstText=" İlk " LabelText=" " LastText=" Son " NextText=" > " QueryStringKey="Sayfa" ResultsFormat="Sayfa {0}-{1} (Toplam {2} ilan)" ControlCssClass="Sayfalama" MaxPages="1000"  ></cc1:CollectionPager>
