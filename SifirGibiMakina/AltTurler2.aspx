<%@ Page Title="" Language="C#" MasterPageFile="~/Makina.Master" AutoEventWireup="true" CodeBehind="AltTurler2.aspx.cs" Inherits="SifirGibiMakina.AltTurler2" %>
...
.Sayfalama span{
    ...
    padding: 0 5px;
                       ...
                       <cc1:CollectionPager ID="CollectionPager1" PageSize="9" runat="server" BackNextLocation="Split" BackText=" < "   FirstText=" İlk " LabelText=" " LastText=" Son " NextText=" > " QueryStringKey="Sayfa" ResultsFormat="Sayfa {0}-{1} (Toplam {2} ilan)" ControlCssClass="Sayfalama" MaxPages="10000"></cc1:CollectionPager>
     ...
     <div class="form-group">
          ...
          <div class="row">
            <asp:Repeater ID="rptUrunlerMobil" runat="server" OnItemDataBound="rptUrunler_ItemDataBound">
              ...
              <cc1:CollectionPager ID="CollectionPager2" PageSize="9" runat="server" BackNextLocation="Split" BackText=" < "   FirstText=" İlk " LabelText=" " LastText=" Son " NextText=" > " QueryStringKey="Sayfa" ResultsFormat="Sayfa {0}-{1} (Toplam {2} ilan)" ControlCssClass="Sayfalama" MaxPages="10000"></cc1:CollectionPager>
