<%@ Page Title="" Language="C#" MasterPageFile="~/Makina.Master" AutoEventWireup="true" CodeBehind="MesajGonder.aspx.cs" Inherits="SifirGibiMakina.MesajGonder" %>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-3 text-secondary"><asp:Literal ID="ltFiyat" runat="server" ></asp:Literal>	<asp:Literal ID="ltParaBirimi" runat="server"></asp:Literal></div>
                      ...
                      <asp:Repeater ID="rtMesajlar" runat="server" Visible="false">
                                    <ItemTemplate>
