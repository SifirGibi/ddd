<%@ Page Title="" Language="C#" MasterPageFile="~/Makina.Master" AutoEventWireup="true" CodeBehind="Markalar.aspx.cs" Inherits="SifirGibiMakina.Markalar" %>
          ...
          <div class="row">
                ...
                <div class="card mt-3 sm-d-none">
                  ...
                  <div class="card-body p-0">
                    ...
                    <div class="filtreleri-sifirla">
                         <asp:Button ID="btnTumu" runat="server" Text="FİLTRE AYARLARINI SIFIRLA" CssClass="btn btn-secondary" Width="100%" OnClick="btnTumu_Click"/>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-9">
              <div class="vitrin-makineleri">
                <h3 class="title"><asp:Label ID="lblMarkaH1" runat="server"></asp:Label></h3>
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
...
.Sayfalama span{
    ...
    padding: 0 5px;
                       ...
                       <cc1:CollectionPager ID="CollectionPager1" PageSize="27" runat="server" BackNextLocation="Split" BackText=" < "   FirstText=" İlk " LabelText=" " LastText=" Son " NextText=" > " QueryStringKey="Sayfa" ResultsFormat="Sayfa {0}-{1} (Toplam {2} ilan)" ControlCssClass="Sayfalama" MaxPages="10000"></cc1:CollectionPager>
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                                <p class="text-12-14-500 text-gray-light mb-0"><asp:Label ID="lblMarkaDesc" runat="server" CssClass="text-dark"></asp:Label></p>
                               <hr style="width:100%"/>
                      </div>
                    </div>
                  </div>
