<%@ Page Title="" Language="C#" MasterPageFile="~/Makina.Master" AutoEventWireup="true" CodeBehind="Ihaleler.aspx.cs" Inherits="SifirGibiMakina.Ihaleler" EnableEventValidation="true"%>
                ...
                <div class="card sm-d-none">
                  <div class="card-header">İlan Arama</div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                         <asp:DropDownList ID="ddTurlerAlt" runat="server" CssClass="form-control select2" Width="100%">
                        </asp:DropDownList>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="card mb-4">
                              <div class="position-relative">
                                ...
                                <div class="card-price">
                                  <h4><%# Eval("Fiyat","{0:0,0}") %>&nbsp;<asp:Literal ID="ltParaBirimi" runat="server"></asp:Literal></h4>
                                </div>
                              </div>
...
.Sayfalama span{
    ...
    padding: 0 5px;
     ...
     <div class="form-group">
                        ...
                        <div class="form-group">
                         <asp:DropDownList ID="ddTurlerAltMobil" runat="server" CssClass="form-control select2" Width="100%">
                        </asp:DropDownList>
                        </div>
                        <div class="form-group">
                  ...
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-7">
                      <div class="card-body">
                        ...
                        <p class="card-price"><%# Eval("Fiyat","{0:0,0}") %>&nbsp;<asp:Literal ID="ltParaBirimi" runat="server"></asp:Literal></p>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="row">
                          <div class="col-12">
                              <div class="box">
                                ...
                                <span><strong> <%# Eval("Fiyat","{0:0,0}") %>&nbsp;<asp:Literal ID="ltParaBirimi" runat="server"></asp:Literal></strong></span>
                              </div>
                          </div>
                          <div class="col-12">
                              <div class="box">
