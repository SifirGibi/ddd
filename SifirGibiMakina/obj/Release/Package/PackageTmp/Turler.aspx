<%@ Page Title="" Language="C#" MasterPageFile="~/Makina.Master" AutoEventWireup="true" CodeBehind="Turler.aspx.cs" Inherits="SifirGibiMakina.Turler" %>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="vitrin-makineleri">
                <h1><asp:Label ID="lblTurH1" runat="server"></asp:Label></h1>
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                            <hr style="width:100%"/>
                                <p class="text-12-14-500 text-gray-light mb-0"><asp:Label ID="lblTurDesc" runat="server" CssClass="text-dark"></asp:Label></p>
                    ...
                    <div class="col-md-12 listing-v2" id="collapseTwo" aria-labelledby="headingTwo" data-parent="#listing-accordion">
                      <div class="row">
                           <asp:Label ID="lblSonuc" runat="server" Visible="false" CssClass="text-center" Width="100%" ForeColor="Red"></asp:Label>
                              <asp:Repeater ID="rptUrunler" runat="server" OnItemDataBound="rptUrunler_ItemDataBound" EnableViewState="false">
                        <ItemTemplate>
                              ...
                              <div class="card mb-4">
                                  ...
                                  <div class="card-body">
                                      ...
                                      <p class="card-work mb-1">
                                           <a href="/ilan-<%# Eval("SEOUrl") %>"><%# Eval("TurAdı") %></a>
                                        </p>
                                      ...
                                      <div class="card-features">
                                          <div class="row">
                                              <div class="col-md-8 border-right">
                                                 ...
                                                 <span>Marka <br /><%# Eval("MarkaAdı") %></span>
                                              </div>
                                              <div class="col-md-4 text-center">
                                                  <i class="fas fa-calendar"></i>
                                                  <span>Yıl <br /><%# Eval("MachineYear") %></span>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
...
.Sayfalama span{
    ...
    padding: 0 5px;
                      ...
                      <cc1:CollectionPager ID="CollectionPager1" PageSize="24" runat="server" BackNextLocation="Split" BackText=" < "   FirstText=" İlk " LabelText=" " LastText=" Son " NextText=" > " QueryStringKey="Sayfa" ResultsFormat="Sayfa {0}-{1} (Toplam {2} ilan)" ControlCssClass="Sayfalama" MaxPages="1000"  ></cc1:CollectionPager>
                      </div>
                ...
                <div class="collapse" id="mobileCollapse">
                  <div class="card">
                    <div class="card-header">İlan Arama</div>
                      <div class="card-body">
     <div class="form-group">
                            <asp:DropDownList ID="ddTurlerMobil" runat="server" CssClass="form-control select2" Width="100%" OnSelectedIndexChanged="ddTurler_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                        </div>
                        <div class="form-group">
                         <asp:DropDownList ID="ddTurlerAltMobil" runat="server" CssClass="form-control select2" Width="100%" OnSelectedIndexChanged="ddTurlerAlt_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                        </div>
                           <div class="form-group">
          ...
          <div class="row">
            ...
            <asp:Repeater ID="rptUrunlerVitrinMobil" runat="server" OnItemDataBound="rptUrunler_ItemDataBound">
                        <ItemTemplate>
                            <div class="col-12">
            ...
            <asp:Repeater ID="rptUrunlerMobil" runat="server" OnItemDataBound="rptUrunlerVitrin_ItemDataBound">
                        <ItemTemplate>
              ...
              <div class="makine-liste-card">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-date">
                      <a href="/ilan-<%# Eval("SEOUrl") %>" style="color:#8E8E8E"><%# Eval("TurAdı") %></a>
                    </p>
                    ...
                    <div class="card-features">
                      <div class="row">
                          ...
                          <div class="col-12">
                              <div class="box">
                                <i class="fas fa-tag"></i>
                                <span><strong>Marka</strong>  <%# Eval("MarkaAdı") %></span>
                              </div>
                          </div>
                          ...
                          <div class="col-12">
                            <div class="box">
                              <i class="fas fa-calendar"></i>
                              <span><strong>Yıl</strong> <%# Eval("MachineYear") %></span>
                            </div>
                          </div>
                      </div>
                    </div>
