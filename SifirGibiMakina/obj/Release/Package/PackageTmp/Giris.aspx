                ...
                <div class="login-left bg-light">
                    <h4>Üye Giriþi</h4>
                        ...
                        <div class="form-group mb-3">
                            <input type="password" class="form-control" name="txtSifre" id="txtSifre" placeholder="Þifre" runat="server" required="" size="50">
                        </div>
                        <div class="form-group form-check mb-0">

                          <a href="/sifremi-unuttum" class="sifremi-unuttum">Þifremi Unuttum</a>
                        </div>
                        <div class="text-center">
                            ...
                            <asp:Button ID="btnGiris" runat="server" Text="Giriþ Yap"  CssClass="btn btn-success login-button" OnClick="btnGiris_Click"/>
                        </div>
                        <div class="text-center uye-ol">
                            <p>
                                Henüz üye deðil misin?
                            </p>
