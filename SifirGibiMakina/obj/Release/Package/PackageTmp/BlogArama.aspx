<%@ Page Title="" Language="C#" MasterPageFile="~/Makina.Master" AutoEventWireup="true" CodeBehind="BlogArama.aspx.cs" Inherits="SifirGibiMakina.BlogArama" %>
            ...
            <div class="container">
                ...
                <div class="blog-main">
                    <div class="row">
                       ...
                       <cc1:CollectionPager ID="CollectionPager1" PageSize="5" runat="server" BackNextLocation="Split" BackText=" <  "   FirstText="İlk" LabelText=" " LastText="Son" NextText="  >  " QueryStringKey="Sayfa" ResultsFormat="Sayfa {0}-{1} (Toplam {2})" ControlCssClass="blog-link"></cc1:CollectionPager>
                        </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="blog-sidebar">
                                ...
                                <div class="en-cok-okunanlar">
                                   ...
                                   <asp:Repeater ID="rptEncokOkunanlar" runat="server" OnItemDataBound="rptBlog_ItemDataBound">
                        <ItemTemplate>
