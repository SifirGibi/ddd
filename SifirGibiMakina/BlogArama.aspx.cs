...
{
    public partial class BlogArama : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    //Blog Kategori ID
                    int pageid = 1;
                    if (RouteData.Values["keyword"] != null || Request.QueryString["keyword"] !=null )
                    {
                        string keyword = "";
                        if (RouteData.Values["keyword"] != null)
                        {
                        ...
                        var sorgu = from c in nt.tbl_Duyurular
                                    ...
                                    where c.Durum == true && c.dil_ID == 1 && c.cat_ID == pageid && c.Yayinda == true && (c.Baslik.Contains(keyword) || c.KisaAciklama.Contains(keyword) || c.Icerik.Contains(keyword) || c.SeoKeywords.Contains(keyword) || c.SeoDescription.Contains(keyword))
                    ...
                    rptEncokOkunanlar.DataSource = haberenconokunanlarsorgu.ToList().Take(5);
