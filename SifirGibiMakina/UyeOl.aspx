...
/* Alt kategoriler */
.custom-listbox option:not([disabled]) {
    padding-left: 20px; 
                    ...
                    <h4>Üye Ol</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6 px-025rem sm-px-15px sm-mb-8">
                                    <input type="email" class="form-control" id="txtEmail" placeholder="E-Posta" name="txtEmail" required="" runat="server"  autocomplete="none" >
                                      <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEmail" ErrorMessage="E-Mail formatýnda giriniz." Font-Size="Smaller" ForeColor="#CC3300" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator> 
                          
                                </div>
                                <div class="col-md-6 px-0px sm-px-15px">
                                 <input type="tel" id="txtTelefon" name="txtTelefon" class="form-control" runat="server" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                     ...
                     <div class="form-group mb-025rem sm-mb-8">
                        ...
                        <div class="form-group mb-025rem sm-mb-8">
                            <div class="row">
                                <div class="col-md-6 px-025rem sm-px-15px sm-mb-8">
                          <input type="password" class="form-control" id="txtSifre" placeholder="Þifre" name="txtSifre" required="" runat="server" oninput="validatePassword()">
        ...
        $(function () {
            ...
            <script>
                ...
                function validatePassword() {
                    var password = document.getElementById('txtSifre').value;
                    var passwordError = document.getElementById('passwordError');
                    var isValid = true;

                    if (password.length < 8) {
                        passwordError.innerHTML = 'Þifre en az 8 karakter olmalýdýr.';
                        isValid = false;
                    } else if (!/\d/.test(password)) {
                        passwordError.innerHTML = 'Þifre en az bir rakam içermelidir.';
                        isValid = false;
                    } else if (!/[a-zA-Z]/.test(password)) {
                        passwordError.innerHTML = 'Þifre en az bir harf içermelidir.';
                        isValid = false;
                    } else {
