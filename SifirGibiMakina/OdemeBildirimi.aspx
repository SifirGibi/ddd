              ...
              <div class="row">
                ...
                <div class="col-md-6">
                     <div class="form-group">
                           <h5 class="form-title success">Ödeme Yapılacak Banka</h5> 
                  ...
                  <div class="form-group">
                        <h5 class="form-title success">Banka</h5> 
                     ...
                     <div class="form-group">
                           <h5 class="form-title success">Dekont No</h5> 
                  ...
                  <div class="col-md-6">
                <div class="form-group">
                      <h5 class="form-title success">Gönderen Adı</h5> 
...
=======
                      <div class="form-group">
                            <h5 class="form-title success">Ödenen Miktar</h5> 
>>>>>>> 0491db9d5dd9af87c178e0a709d8ca7a2d62e411
                ...
                <div class="row">
                    <div class="col-md-12">
                          <div class="form-group">
                                <h5 class="form-title success">Açıklama</h5> 
